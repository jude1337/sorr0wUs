## *Note: This repository is an unofficial continuation of ToU due to the original repository being discontinued.*

![LOGO](./Images/s0U-logo.png)
![Roles](./Images/Roles.png)

An Among Us mod that adds a bunch of roles, modifiers and game settings

Join our [Discord](https://discord.gg/SWv3aXFTAd) if you have any problems or want to find people to play with!
...
**1. [Download](#releases) the sorr0wUs version corresponding to the installed Among Us version.**\
\
...
**11. Click on Enter.**\
\
**12. Copy or move the contents of the sorr0wUs zip file into the AmongUs folder.**\
\
...
<br/>
## Issues
If you have issues installing sorr0wUs, you can join our [Discord](https://discord.gg/SWv3aXFTAd) to receive help.
...
-----------------------
# Bug / Suggestions
If you have any bugs or any need to contact me, join the [Discord Server](https://discord.gg/SWv3aXFTAd) or create a ticket on GitHub.
